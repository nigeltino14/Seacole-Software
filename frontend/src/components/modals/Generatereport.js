            ...
            <div className="ms-panel ms-panel-bshadow-none">
                ...
                <div className="ms-panel-body">
                    <Form noValidate validated={validated} onSubmit={handleSubmit}>
                        ...
                        <Button type="submit" variant="warning" className="mt-4 d-inline w-20 mr-2">Generate Report</Button>
                        <Button type="button" className="mt-4 d-inline w-20">Generate &amp; Print</Button>
                    </Form>
                </div>
            </div>
        </div>
